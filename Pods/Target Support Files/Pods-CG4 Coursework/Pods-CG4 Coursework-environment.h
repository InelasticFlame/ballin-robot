...
// FRDStravaClient
#define COCOAPODS_POD_AVAILABLE_FRDStravaClient
#define COCOAPODS_VERSION_MAJOR_FRDStravaClient 1
#define COCOAPODS_VERSION_MINOR_FRDStravaClient 0
#define COCOAPODS_VERSION_PATCH_FRDStravaClient 2
